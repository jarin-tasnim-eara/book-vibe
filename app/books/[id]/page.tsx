      ...
      <div className="flex flex-col md:flex-row gap-10 items-start">
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-4 mt-2">
            <button className="px-6 py-2 border border-gray-400 text-gray-700 rounded-md hover:bg-gray-100 font-medium">
              Read
            </button>
            <button className="px-6 py-2 bg-cyan-400 text-white rounded-md hover:bg-cyan-500 font-medium">
              Wishlist
            </button>
          </div>
